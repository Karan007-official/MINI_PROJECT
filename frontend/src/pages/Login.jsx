...
function Login() {
  ...
  return (
    <div className="min-h-screen bg-gray-950 flex items-center justify-center p-4">
      ...
      {/* Glow blob */}
      <div className="fixed top-1/4 left-1/2 -translate-x-1/2 -translate-y-1/2 w-96 h-96 bg-violet-600/10 rounded-full blur-3xl pointer-events-none" />
      ...
      <div className="relative w-full max-w-md">
        ...
        <div className="bg-gray-900/80 border border-white/10 backdrop-blur-xl rounded-3xl p-8 shadow-2xl">
          ...
          <div className="text-center mb-8">
            ...
            <p className="text-gray-400 text-sm mt-1">Sign in to your SpendSmart account</p>
          </div>
